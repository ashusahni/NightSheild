      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="relative group max-w-5xl mx-auto">
            ...
            <div className="relative bg-gradient-to-br from-[#0B0B0F]/95 via-[#1A1A1F]/90 to-[#0B0B0F]/95 backdrop-blur-xl border border-red-500/30 rounded-3xl p-10 shadow-2xl">
              <motion.h3 
                initial={{ opacity: 0, y: 10 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.2 }}
                viewport={{ once: true }}
                className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-white via-gray-200 to-white bg-clip-text text-transparent"
              >
              ...
              >
                <motion.button
                  ...
                  className="relative group py-4 px-10 rounded-xl font-semibold text-white bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 transition-all duration-300 shadow-lg shadow-red-500/25 hover:shadow-red-500/40"
                >
                ...
                <motion.button
                  ...
                  className="relative group py-4 px-10 rounded-xl font-semibold text-white bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-600 hover:to-gray-700 border border-gray-600/50 hover:border-gray-500/50 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
