    ...
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-card-bg border border-red-500/20 rounded-2xl overflow-hidden"
        >
          {/* Table Header */}
          <div className="grid grid-cols-3 bg-red-500/10 p-6">
            <div className="text-center">
              <h3 className="text-xl font-bold text-white">Feature</h3>
            </div>
            <div className="text-center">
              <h3 className="text-xl font-bold text-gray-400">Traditional Security</h3>
            </div>
            <div className="text-center">
              <h3 className="text-xl font-bold text-red-500">NightShield</h3>
            </div>
          </div>
          ...
          <div className="divide-y divide-red-500/20">
            {comparisonData.map((row, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className={`grid grid-cols-3 p-6 hover:bg-red-500/5 transition-colors duration-200 ${
