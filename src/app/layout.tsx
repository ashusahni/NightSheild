...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/NIGHTSHIELD (4).png', sizes: 'any', type: 'image/png' },
      { url: '/NIGHTSHIELD (4).png', sizes: '32x32', type: 'image/png' },
      { url: '/NIGHTSHIELD (4).png', sizes: '192x192', type: 'image/png' },
      { url: '/NIGHTSHIELD (4).png', sizes: '512x512', type: 'image/png' },
    ],
    apple: [
      { url: '/NIGHTSHIELD (4).png', sizes: '180x180' },
    ],
    shortcut: '/NIGHTSHIELD (4).png',
  },
